...
!====================================================================
! Copy of MODFLOW 6, v.6.2.1 SimulationCreateModule that has been 
...
! SPECIFICATIONS:
  ...
  implicit none
  private
  public :: cphsimulation_cr
  public :: cphsimulation_da
...
! ------------------------------------------------------------------------------
    ...
    ! -- Return
    return
  end subroutine cphsimulation_cr
...
end module cphSimulationCreateModule
