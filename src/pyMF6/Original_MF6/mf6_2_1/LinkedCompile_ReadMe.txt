...
#		MODFLOW 6, version 6.2.1 distribution downloaded from the USGS
...
# 3. Copy the file pyHS2MF6\installation\modmakefile to C:\mf6_2_1\make
...
#  (phys2mf6) cd C:\mf6_2_1\make 

# 5. Create DLL file, mf6.dll 
#   (phys2mf6) C:\mf6_2_1\make > mingw32-make.exe --makefile=modmakefile all

# 6. Create the PYD file, pyMF6.cp38-win_amd64.pyd. Need to copy/move mf6.dll to C:\mf6_2_1\make
#   (phys2mf6) C:\mf6_2_1\make > f2py.exe -c -m pyMF6 -L.\ -lmf6 -I.\obj_temp\ -I.\mod_temp\ --verbose .\cp_Modules\f2PWrappers.f90 
