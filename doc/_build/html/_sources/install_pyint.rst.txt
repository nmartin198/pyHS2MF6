...
Python 3.7 is the only version with which pyHS2MF6 has been used and 
tested. Consequently, it is recommended to use Python 3.7.
...
used for pre- and post-processing in the test case model.
